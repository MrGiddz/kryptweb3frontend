  ...
  return (
    <nav className='w-full flex md:justify-center justify-between items-center p-4'>
      ...
      <div className='flex relative'>
        ...
        {toggleMenu && (
          <ul
            className='z-10 fixed top-0 -right-2 p-3 w-[70vw] flex h-screen shadow-2xl md:hidden list-none flex-col justify-start items-end rounded-md blue-glassmorphism text-white animate-slide-in'
          >
            <li className='text-xl w-full my-2'>
              ...
              {
                ["Market", "Exchange", "Tutorials", "Wallets"].map((item, index) => {
                return <NavBarItem key={item + index} title={item} props="my-2 text-lg"/>
                })
              }
          </ul>
        )}
